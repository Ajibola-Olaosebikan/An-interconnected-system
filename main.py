...
#tui.progress('operation', 0)
#records = process.total_records([])
#tui.menu(1)
#select_option = input(f'Select an operation to perform on the data: ')
#if select_option == 1:
    #records = process.total_records([])
    #process.retrieve_records_with_serial_no(records)    #This is to retrieve records with serial number
    ...
    #tui.serial_number()
    #records = process.total_records([])
    #process.retrieve_records_with_serial_no(records)
